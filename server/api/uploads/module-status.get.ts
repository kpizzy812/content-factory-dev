...
export default defineEventHandler(async (event) => {
  ...
  const platforms = {
    ...
    instagram: {
      ...
      maxFileSize: "1GB",
      metadataFields: ["caption", "hashtags", "shareToFeed", "trialParams"],
      limitations: ["Requires a professional Business/Creator account", "Advanced Access is required for accounts outside the Meta app"],
